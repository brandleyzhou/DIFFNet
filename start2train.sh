CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2  train.py --learning_rate 1e-4 --scheduler_step_size 14  --batch_size 16  --model_name mono_model --png --data_path data_path/kitti
